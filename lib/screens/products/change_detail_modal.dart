...
class ChangeDetailModal extends StatefulWidget {
  final int uuId;
  ...
  @override
  _ChangeDetailModalState createState() => _ChangeDetailModalState();
}

class _ChangeDetailModalState extends State<ChangeDetailModal> {
      ...
      if (response['success'] == true) {
        if (mounted) {
          AwesomeDialog(
            ...
            title: 'Succès',
            desc: 'Montant modifié avec succès',
            btnOkText: 'OK',
            btnOkColor: logoBlue, // Bleu logo
            btnOkOnPress: () {
              widget.onSuccess();
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Ajustez le montant par carreau du client',
                style: TextStyle(
                  fontSize: 14,
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.attach_money, color: logoBlue), // Bleu logo
